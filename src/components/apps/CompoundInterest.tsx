...
import { ChevronLeft, Calculator, Info, ShieldCheck, Zap } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';

/**
 * COMPOUND INTEREST PAGE
 * Route: /apps/compound-interest
 */
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
            <h3 className="text-lg font-black text-slate-800 mb-6 flex items-center gap-2">
              <Zap className="text-indigo-600" /> Calculator Coming Soon
            </h3>
            <p className="text-slate-500 font-medium">The compound interest calculator will be implemented here.</p>
          </div>
        </div>
      </main>
