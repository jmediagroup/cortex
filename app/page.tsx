...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 scroll-smooth">
      ...
      {/* NAVIGATION - 72px fixed header with bottom border */}
      <nav className="w-full h-[72px] bg-white border-b border-[#ECEFF2] flex items-center sticky top-0 z-50">
        <div className="max-w-[1440px] w-full mx-auto px-4 md:px-6 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <div className="bg-blue-600 p-1.5 rounded-lg text-white">
              <Brain size={20} />
            </div>
            <span className="font-bold text-2xl tracking-tight">Cortex</span>
          </a>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center gap-6">
            <a href="/articles" className="text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors flex items-center gap-1.5">
              <BookOpen size={16} />
              Articles
            </a>
            ...
            <a
              href="/login"
              className="bg-blue-600 text-white px-5 py-2.5 rounded-xl font-semibold text-sm hover:bg-blue-700 transition-all shadow-md active:scale-95"
            >
              Get Started
            </a>
          </div>
      ...
      {/* HERO SECTION */}
      <main className="max-w-[1440px] mx-auto px-6 pt-12 pb-24 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center">
            <a
              href="#tools"
              className="w-full sm:w-auto bg-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-blue-700 transition-all shadow-xl hover:shadow-blue-200 flex items-center justify-center gap-2 group"
            >
              Explore the Tools
            ...
            <a
              href="/login"
              className="w-full sm:w-auto bg-white text-slate-600 border border-[#ECEFF2] px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all"
            >
              Start Free
            </a>
          </div>
      ...
      {/* WHAT IS CORTEX */}
      <section className="bg-slate-50 py-24 border-y border-[#ECEFF2]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6 tracking-tight">What Is Cortex?</h2>
            <p className="text-xl text-slate-600 font-medium leading-relaxed max-w-3xl mx-auto">
              Cortex is a decision-support platform.
            </p>
          </div>

          <div className="bg-white p-10 lg:p-16 rounded-2xl border border-[#ECEFF2] shadow-sm space-y-8">
            ...
            <div className="pt-8 border-t border-[#ECEFF2]">
      ...
      <section id="tools" className="py-24 scroll-mt-20">
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-emerald-100">
              <Sparkles size={14} />
              Available Now
            </div>
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">Cortex Finance</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div
                key={i}
                className="bg-white p-8 rounded-2xl border border-[#ECEFF2] shadow-sm hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group relative"
              >
                {tool.isFree && (
                  <div className="absolute -top-3 -right-3 bg-emerald-500 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg">
                    Free
                  </div>
                )}
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-800 mb-2">{tool.title}</h4>
          ...
          <div className="text-center mb-12">
            <a
              href="/login"
              className="inline-flex items-center gap-2 bg-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-blue-700 transition-all shadow-xl hover:shadow-blue-200 group"
            >
              Try it free
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </a>
          ...
          <div className="bg-slate-50 p-8 rounded-2xl border border-[#ECEFF2] text-center">
      ...
      <section className="bg-slate-50 py-24 border-y border-[#ECEFF2]">
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-purple-50 text-purple-700 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-purple-100">
              <Compass size={14} />
              Coming Soon
            </div>
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">What We're Building Next</h2>
            <p className="text-xl text-slate-500 font-medium max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-2xl border border-[#ECEFF2] shadow-sm">
                <div className="bg-purple-50 text-purple-600 p-4 rounded-xl w-fit mb-6">
                  {sector.icon}
                </div>
                <h4 className="text-xl font-bold mb-3 text-slate-800">{sector.title}</h4>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">Why Cortex Exists</h2>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={i}
                className="bg-white p-8 lg:p-10 rounded-2xl border border-[#ECEFF2] shadow-sm grid md:grid-cols-2 gap-6 items-center"
              >
                <p className="text-lg text-slate-400 font-medium">{item.left}</p>
                <p className="text-lg text-slate-900 font-bold">{item.right}</p>
              </div>
            ))}
          </div>

          <div className="bg-blue-600 p-10 lg:p-16 rounded-2xl shadow-xl mt-12 text-center">
      ...
      <section className="bg-slate-50 py-24 border-y border-[#ECEFF2]">
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">Simple, Honest Pricing</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* FREE */}
            <div className="bg-white p-8 rounded-2xl border border-[#ECEFF2] shadow-sm">
              <div className="mb-8">
              ...
              <a
                href="/login"
                className="block w-full bg-slate-100 text-slate-900 px-6 py-3.5 rounded-xl font-semibold text-center hover:bg-slate-200 transition-all"
              >
                Start Free
              </a>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border-2 border-blue-600 shadow-xl relative">
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Finance Pro</h3>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-sm">
                    <Check size={16} className="text-blue-600 mt-0.5" strokeWidth={3} />
                    <span className="text-slate-600 font-medium">{feature}</span>
                  </li>
                ))}
              </ul>
              <a
                href="/pricing"
                className="block w-full bg-blue-600 text-white px-6 py-3.5 rounded-xl font-semibold text-center hover:bg-blue-700 transition-all shadow-md"
              >
                Get Finance Pro
              </a>
            </div>
            ...
            {/* ELITE */}
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 p-8 rounded-2xl shadow-xl text-white">
              <div className="mb-8">
              ...
              <a
                href="/pricing"
                className="block w-full bg-white text-purple-600 px-6 py-3.5 rounded-xl font-semibold text-center hover:bg-purple-50 transition-all shadow-md"
              >
                Get Elite
              </a>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">How Cortex Is Different</h2>
          </div>

          <div className="bg-white p-10 lg:p-16 rounded-2xl border border-[#ECEFF2] shadow-sm">
            ...
            <div className="border-t border-[#ECEFF2] pt-12 space-y-6 text-center">
              <p className="text-xl text-slate-600 font-medium">
                It's a <span className="text-slate-900 font-bold">cognitive assistant</span>—a place where logic, time, and consequence meet.
              </p>
              <p className="text-lg text-slate-600 font-medium">
              ...
              <div className="pt-6">
                ...
                <div className="inline-flex items-center gap-3 bg-blue-50 text-blue-900 px-6 py-3 rounded-xl border border-blue-100">
                  <Brain size={24} className="text-blue-600" />
                  <span className="text-2xl font-bold">the cortex.</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-900 text-white py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="mb-12">
            <h2 className="text-4xl font-bold mb-6 tracking-tight">Built on principles, not dark patterns.</h2>
          ...
          <a
            href="/login"
            className="inline-flex items-center gap-2 bg-white text-slate-900 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-100 transition-all shadow-xl group"
          >
      ...
      <footer className="bg-slate-950 py-12 text-center text-slate-400 font-medium text-sm border-t border-slate-800">
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-bold text-slate-300">Cortex</span>
          </div>
