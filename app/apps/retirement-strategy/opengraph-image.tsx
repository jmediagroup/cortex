...
export const alt = 'Retirement Strategy Engine - Advanced Withdrawal Planning Tool';
export const size = {
  width: 1200,
  height: 630,
};
        ...
        <div style={{ display: 'flex', flex: 1, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            <p style={{ fontSize: '24px', fontWeight: 500, color: '#94a3b8', lineHeight: 1.5, maxWidth: '600px' }}>
              Advanced decumulation planning with RMD calculations and tax optimization strategies.
            </p>
          </div>
        </div>
