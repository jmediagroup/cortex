...
function CompoundInterestPageInner() {
  ...
  useEffect(() => { trackToolVisit('compound-interest', 'Compound Interest Calculator', '/apps/compound-interest'); }, []);
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-900/40 dark:to-slate-900 border border-indigo-100/80 dark:border-indigo-800/80 rounded-2xl p-8 mb-8 shadow-sm">
          <h2 className="text-2xl font-black text-indigo-900 dark:text-indigo-100 mb-3">Compound Interest Calculator</h2>
