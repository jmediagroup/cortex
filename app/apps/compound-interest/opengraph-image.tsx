...
export const alt = 'Compound Interest Calculator - Free Investment Growth Tool';
export const size = {
  width: 1200,
  height: 630,
};
        ...
        <div style={{ display: 'flex', flex: 1, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            <p style={{ fontSize: '24px', fontWeight: 500, color: '#94a3b8', lineHeight: 1.5, maxWidth: '600px' }}>
              Visualize long-term wealth growth with custom contributions and compound interest projections.
            </p>
          </div>
        </div>
