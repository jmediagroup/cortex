...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://moneyguymutants.com/apps/coast-fire',
    images: [{
      url: '/og-coast-fire.png',
      width: 1200,
      height: 630,
      alt: 'Money Guy Mutants Coast FIRE Calculator',
    }],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://moneyguymutants.com/apps/coast-fire',
  },
};

const jsonLd = generateCalculatorJsonLd('coast-fire');
