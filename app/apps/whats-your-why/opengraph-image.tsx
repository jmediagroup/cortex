...
export const alt = "What's Your Why — Find Your Real Money Motivation";
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        <div style={{ display: 'flex', flex: 1, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            <p style={{ fontSize: '24px', fontWeight: 500, color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '600px' }}>
              Eight reflective questions that surface what actually drives your financial decisions.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          >
            ...
            <span style={{ fontSize: '16px', fontWeight: 700, color: BRAND.mint, textTransform: 'uppercase', letterSpacing: '1px' }}>Free Reflection</span>
          </div>
