...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://cortex.vip/about' },
};
      ...
      body={
        ...
        >
          <p style={{ margin: 0 }}>
            ...
            <strong style={{ color: 'var(--text-primary)' }}>Cortex Finance</strong>, focuses on personal and small-business finance — where small decisions compound dramatically over time.
          </p>
          <p style={{ margin: 0 }}>
            We design for the part of your brain that plans, weighs outcomes, and resists impulse. Not the part that reacts to notifications, streaks, and countdowns. Cortex makes invisible consequences visible, without pretending life is simple.
          </p>
          <p style={{ margin: 0 }}>
