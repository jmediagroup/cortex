...
export default async function SharedScenarioPage({ params }: SharedScenarioPageProps) {
  ...
  if (!scenario) {
    return (
      <div className="min-h-screen bg-[var(--bg-section)] flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 bg-[var(--bg-glass)] rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Scenario Not Found</h1>
          <p className="text-[var(--text-tertiary)] mb-6">This shared scenario doesn&apos;t exist or is no longer public.</p>
          <Link
            href="/"
