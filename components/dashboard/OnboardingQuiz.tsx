...
export default function OnboardingQuiz({ userId, onComplete, onSkip }: OnboardingQuizProps) {
  ...
  if (showResult) {
    ...
    return (
      <div className="w-full max-w-lg rounded-[var(--radius-2xl)] bg-[var(--surface-primary)] p-8 shadow-xl md:p-10">
  ...
  return (
    <div className="w-full max-w-lg rounded-[var(--radius-2xl)] bg-[var(--surface-primary)] shadow-xl">
      <div className="flex items-center justify-between border-b border-[var(--border-primary)] px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-[var(--text-primary)]">Personalize your dashboard</span>
        </div>
      </div>
